          ...
          <Grid sm={8} container spacing={2}>
            <Grid item>
              ...
              <Typography
                ...
                component="h1"
              >
                Полска се прашува зошто ЕУ и помага на Турција, а не на Турција
                за мигрантите
              </Typography>
              <Box display={"flex"} alignItems={"center"} sx={{ mt: 2 }}>
                ...
                <Typography variant="body2">4 август 2023</Typography>
              </Box>
              <Box
                display={"flex"}
...
`}
            ...
            {latestNews.reverse().map((i) => (
              <Grid item sm={6}>
                <Image
                  src={`https://vestimak-v2.netlify.app/.netlify/images?url=${i.image}&q=35`}
                  alt="A lovely bath"
                  layout="constrained"
                  width={1200}
                  background={placeholder}
                ...
                <Typography variant="body1" fontWeight={"bold"} gutterBottom>
                  Полска се прашува зошто ЕУ и помага на Турција, а не на
                  Турција за мигрантите
                </Typography>
                <Typography variant="body2">
                  Полската агенција за внатрешна безбедност уапси руски хокеар и
                  го обвини за шпионажа за Русија. Ова го пренесе…
                </Typography>
              </Grid>
            ))}
          </Grid>
            ...
            {latestNews.map((i, index) => (
              <>
                <Box sx={{ mt: 1 }}>
                  ...
                  {index % 3 === 2 && ( // Show the ad every 3rd time (index % 3 === 2)
                    <Box
                      sx={{
                        bgcolor: "grey",
                        color: "white",
                    ...
                    >
                      <Typography variant="h6">ВАШАТА РЕКЛАМА</Typography>
                    </Box>
                  )}
                  <Divider />
                </Box>
